...
openssl req -key client-key.pem -new -out client.csr -subj "/C=DE/ST=Hessen/L=FRA/O=FRA-UAS/OU=FB2/CN=b8:27:eb:e8:40:6f/emailAddress=tls@gmail.com"
...
openssl x509 -req -in client.csr -CA ../ca/ca-cert.pem -CAkey ../ca/ca-key.pem -CAcreateserial -out client-cert.pem -extfile client-ext.cnf
