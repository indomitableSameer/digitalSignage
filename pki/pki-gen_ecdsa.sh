...
openssl req -new -x509 -key ca-key.pem -out ca-cert.pem -subj "/C=DE/ST=Hessen/L=FRA/O=FRA-UAS/OU=FB2/CN=*.test/emailAddress=test@gmail.com"
...
openssl req -key server-key.pem -new -out server.csr -subj "/C=DE/ST=Hessen/L=FRA/O=FRA-UAS/OU=FB2/CN=*.tls/emailAddress=tls@gmail.com"
